...
Bed.HEALTH_MANA_PER_TICK = 4
Bed.HEALTH_MANA_TICK_SECONDS = 60
Bed.HEALTH_MANA_MAX_SECONDS = 100 * 60
Bed.SOUL_PER_TICK = 1
Bed.SOUL_TICK_SECONDS = 15 * 60
Bed.OFFLINE_TRAINING_ENABLED = true
